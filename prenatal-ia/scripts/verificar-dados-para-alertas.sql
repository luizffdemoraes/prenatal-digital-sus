...
-- 1) Gestações ativas (mesmo critério do prenatal-ia: cpf preenchido, 1 a 44 semanas)
...
-- Se quantidade = 0 acima: o job não encontra ninguém, não chama o n8n e não envia e-mail.
