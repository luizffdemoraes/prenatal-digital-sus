...
-- O prenatal-ia lê prontuario.prontuario.email_paciente. Se o cadastro foi feito com emailPaciente (ex.: maria.silva@tuamaeaquelaursa.com), este SELECT deve mostrar o valor.
-- Executar no MESMO banco em que o prenatal-ia conecta (ex.: psql -U postgres -d prenatal_digital_sus -f scripts/definir-email-gestante-tuamaeaquelaursa.sql)
