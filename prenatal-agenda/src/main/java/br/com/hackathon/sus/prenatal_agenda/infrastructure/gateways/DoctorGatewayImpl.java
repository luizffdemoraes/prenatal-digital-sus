...
/**
 * Stub implementation for development. Replace with actual professional service in production.
 */
public class DoctorGatewayImpl implements DoctorGateway {
    ...
    public Optional<Long> buscarPorCrm(String crm) {
        ...
        return Optional.ofNullable(POR_CRM.get(crm.trim().replaceAll("\\D", "")));
    }
