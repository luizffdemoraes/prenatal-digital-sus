...
public class AgendaMedicoEntity {
    ...
    private Set<DiaSemana> diasAtendimento = new HashSet<>();
    ...
    public AgendaMedicoEntity() {
    }

    public AgendaMedicoEntity(Long id, Long medicoId, Long unidadeId, Set<DiaSemana> diasAtendimento,
